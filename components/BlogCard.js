...
export default function BlogCard({ slug, title, date, category, tags = [], summary, externalUrl }) {
  const cardBody = (
  ...
  if (externalUrl) {
    return (
      <a href={externalUrl} target="_blank" rel="noopener noreferrer" style={{ display: 'block' }}>
        {cardBody}
      </a>
    );
  }
